INSERT INTO t_local
    (lang, str_id, text)
VALUES
    ( "en", "switch_lang_shortcut", "cs" ),
    ( "en", "switch_lang_caption", "ČESKY" ),
    ( "en", "what_is_lmb_caption", "What is LMB Party?" ),
    ( "en", "directions_caption", "Directions" ),
    ( "en", "accomodation_caption", "Accomodation" ),
    (
        "en",
        "whatis_text1",
    ...
    ( "en", "more_info_soon", "More information to come soon." ),
    
    ( "cs", "switch_lang_shortcut", "en"),
    ( "cs", "switch_lang_caption", "ENGLISH"),
    ( "cs", "what_is_lmb_caption", "Co je LMB Party?"),
    ( "cs", "directions_caption", "Doprava a umístění"),
    ( "cs", "accomodation_caption", "Ubytování"),
    (
        "cs",
        "whatis_text1",
   ...
   ( "cs", "more_info_soon", "Více informací již brzy." );
